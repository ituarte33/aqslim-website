...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: 'https://www.aqslim.com/icons/myaqslim-192.png', sizes: '192x192', type: 'image/png' },
      { url: 'https://www.aqslim.com/icons/myaqslim-512.png', sizes: '512x512', type: 'image/png' },
    ],
    shortcut: [{ url: 'https://www.aqslim.com/icons/myaqslim-192.png', type: 'image/png' }],
    apple: [
      { url: 'https://www.aqslim.com/icons/myaqslim-apple-touch-icon.png', sizes: '180x180', type: 'image/png' },
    ],
  },
}
